      ...
      <div className='relative flex h-20 items-center justify-between'>
        <div className='absolute inset-y-0 left-0 flex items-center md:hidden'>
          ...
          <button
            ...
            className='relative inline-flex items-center justify-center rounded-md p-2 text-zinc-700 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white'
        ...
        <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
          ...
          <a className='flex flex-shrink-0 items-center' href='/index.html'>
            <Image className='h-10 w-auto' src={logo} alt='Аренда Недвижимости' />
          ...
          <div className='hidden md:ml-6 md:block'>
            <div className='flex space-x-2'>
              <a
                href='/index.html'
                className='text-zinc-700 bg-amber-300 hover:bg-amber-500 hover:text-zinc-700 rounded-md px-3 py-2'
              >
                Главная
              </a>
              <a
                href='/properties.html'
                className='text-zinc-700 hover:bg-amber-500 hover:text-zinc-700 rounded-md px-3 py-2'
              >
                Недвижимость
              </a>
              <a
        ...
        <div className='hidden md:block md:ml-6'>
          <div className='flex items-center'>
            <button className='flex items-center  bg-amber-300 hover:bg-amber-500 hover:text-zinc-700 rounded-md px-3 py-2'>
              <i className='fa-brands fa-google text-zinc-700 mr-2'></i>
              <span>Вход</span>
            </button>
          </div>
        </div>
